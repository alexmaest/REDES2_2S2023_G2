...
El OSPF es un protocolo de enrutamiento dinámico que se utiliza para enrutar paquetes dentro de una red de computadoras, por lo que se procede a configurar el mismo sobre los 2 switches capa 3 de la topología, como se muestra a continuación:

- Configuración sobre MSW3 perteneciente a la sucursal de Huehuetenango:

![OSPF](images/ospf_01.png)

- Configuración sobre MSW2 perteneciente a la sucursal de Sololá:

![OSPF](images/ospf_02.png)

## EIGRP

El EIGRP es un protocolo de enrutamiento de estado de enlace, que se utiliza para enrutar paquetes dentro de una red de computadoras, por lo que se procede a configurar el mismo sobre 2 de los 3 switches capa 3 de la topología, como se muestra a continuación:

- Configuración sobre MSW3 perteneciente a la sucursal de Huehuetenango:

![EIGRP](images/eigrp_01.png)

- Configuración sobre MSW1 perteneciente a la sucursal de Retalhuleu:

![EIGRP](images/eigrp_02.png)

## Pruebas de conectividad

### Pruebas de conectividad entre las sucursales

- Ping entre RRHH de Retalhuleu (192.168.22.4) y Soporte de Huehuetenango (192.168.12.2):

![PING](images/ping_04.png)

- Ping entre RRHH de Retalhuleu (192.168.22.4) e IT de Sololá (192.168.32.3):

![PING](images/ping_05.png)

- Ping entre Soporte de Huehuetenango (192.168.12.2) e IT de Sololá (192.168.32.3):

![PING](images/ping_06.png)
